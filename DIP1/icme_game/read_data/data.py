...
class DatasetFromFolder(data.Dataset):
    def __init__(self, image_dir='/home/PublicStore/lanyuting/project/dataset', transform=None):
        super(DatasetFromFolder, self).__init__()
        self.data_dir = "{}/Training/".format(image_dir)
        self.dir_filenames = [join(self.data_dir, x) for x in listdir(self.data_dir)]
        print(self.dir_filenames)
    ...
    def __getitem__(self, index):
        ...
        pd_data = pd.read_csv(path_csv).Color
        print(pd_data)
...
class TestFromFolder(data.Dataset):
    def __init__(self, image_dir='/home/PublicStore/lanyuting/project/dataset', transform=None):
        ...
        self.data_dir = "{}/Test/".format(image_dir)
        self.dir_filenames = [join(self.data_dir, x) for x in listdir(self.data_dir)]
        self.dir_file_num = len(self.dir_filenames)
        self.transform = transform
