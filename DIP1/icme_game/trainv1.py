from read_data.datav1 import DatasetFromFolder, TestFromFolder
# coding=utf-8
import time
import argparse
import os
...
parser.add_argument("--tag", type=str, help="tag for this training", default='Texture')
...
parser.add_argument("--num_mcs", type=str, help="num of mcs", default='Texture')
